export const projects = [
  {
    ...
    liveUrl: "https://lexreg-africa.vercel.app/",
  ...
  },
  {
    ...
    liveUrl: "https://luxeroam-luxeroam.vercel.app/",
    video: "/videos/luxe-roam-preview.mp4",
    tagline: "A bespoke itinerary engine with direct WhatsApp booking.",
    seoDescription:
      "Luxe Roam replaced slow email booking with a bespoke itinerary engine and direct WhatsApp checkout — reservations that took days now close in one conversation.",
    challenge:
  ...
  },
  {
    ...
    liveUrl: "https://lunagraphics.co.ke",
    ...
    seoDescription:
      "Luna Graphics replaced spreadsheet order tracking with an automated pipeline for inventory and client proofing, saving hundreds of hours a month.",
    challenge:
  ...
  },
  {
    ...
    seoDescription:
      "Luna Politics is a civic engagement platform engineered for high-traffic campaign moments — lightweight, built to stay fast and reliable under sudden spikes.",
    challenge:
  ...
  },
  {
    ...
    liveUrl: "https://luxeandallureevents.co.ke",
    ...
    seoDescription:
      "Luxe & Allure Events runs a custom booking system for client proposals and scheduling that lifted inquiry conversion by 40% within two months.",
    challenge:
  ...
  },
  {
    ...
    liveUrl: "https://novaluxuryeventske.com",
    ...
    seoDescription:
      "Nova Luxury Events runs on a platform engineered to stay fast and stable through major launch traffic, setting a new performance benchmark for luxury events.",
    challenge:
  ...
  },
  {
    ...
    liveUrl: "https://brandmarkprintmedia.com",
    ...
    seoDescription:
      "Brandmark Print Media is an e-commerce storefront for signage, vehicle wraps, DTF apparel, and merch — catalog, quotes, and WhatsApp ordering in one flow.",
    challenge:
  ...
  },
  {
    ...
    liveUrl: "https://zenoevents.vercel.app",
  ...
  },
  {
    ...
    liveUrl: "https://www.adedeadvocates.co.ke/",
    ...
    seoDescription:
      "Adede & Co is a law firm site covering all 8 practice areas, with a clear 4-step process and consultation booking guaranteeing a 1-business-day response.",
    challenge:
  ...
  },
  {
    ...
    color: "orange",
    isConcept: true,
    image: "/showcase-yopersh.jpg",
    liveUrl: "https://yourpersh.vercel.app/",
    video: "/videos/yopersh-preview.mp4",
    gallery: [
      "/gallery/yopersh-1.webp",
      "/gallery/yopersh-2.webp",
      "/gallery/yopersh-3.webp",
      "/gallery/yopersh-4.webp",
      "/gallery/yopersh-5.webp",
    ],
    tagline: "A weekend concept redesign that shows the delivered price and the order's journey up front.",
    seoDescription:
      "Yopersh is a weekend concept site for a Dubai-to-East-Africa personal shopper, with a live quote box, an order tracker demo and WhatsApp ordering.",
    challenge:
      "Yopersh is a personal shopper that buys from Shein, Temu and Amazon, consolidates in Dubai, and delivers to Uganda and Kenya. Those stores often refuse to ship to East African addresses, and a shopper deciding whether to trust a middleman wants to see the price and the route before they message anyone.",
    approach:
      "We built this on our own time, as a concept rather than client work. The page opens on a globe tracing the Dubai route, then explains the two ways to order and draws the journey from store to Dubai hub to Nairobi to the door. An interactive box lets visitors drag in sample items to see a delivered price, using the 10% service fee from Yopersh's own FAQ, and a demo tracker follows an order end to end. Ordering itself stays on WhatsApp.",
    outcome:
      "A concept site where the price and the delivery path are visible before the first message, instead of hidden behind a chat. It is a demo: item prices and the tracking code are illustrative, and it is not affiliated with the stores it mentions.",
    quote: null,
    quoteAuthor: null,
    quoteRole: null,
  },
  {
    ...
    color: "rose",
    isConcept: true,
    image: "/showcase-aziza.jpg",
    liveUrl: "https://aziza-beta.vercel.app/",
    video: "/videos/aziza-preview.mp4",
    gallery: [
      "/gallery/aziza-1.webp",
      "/gallery/aziza-2.webp",
      "/gallery/aziza-3.webp",
      "/gallery/aziza-4.webp",
      "/gallery/aziza-5.webp",
    ],
    tagline: "A student portfolio built as a desk you can restyle, with a notebook that opens.",
    seoDescription:
      "Aziza is an interactive student portfolio built as a desk you can restyle: an opening notebook, colour themes, a lamp that lights and an iPod menu.",
    challenge:
      "A portfolio for a student who describes herself as a maximalist should not read like a CV. It needed to feel like a person: colourful, a little chaotic, and fun to poke at.",
    approach:
      "We built it as a desk seen from above. A notebook sits in the middle and opens to pages about her, her achievements and what is next. Around it, the desk is playable: visitors change the cover colour and the background, hit a surprise button for a random palette, light the desk lamp, swap between workspace, journal and stationery sets, add stickers, and use an iPod with its own menu.",
    outcome:
      "A weekend build that turns a portfolio into something you play with before you read it. It is a personal project, not a client engagement.",
    quote: null,
    quoteAuthor: null,
    quoteRole: null,
  },
