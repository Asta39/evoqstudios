export const projects = [
  {
    ...
    tagline: "Real-time regulatory filing engine built for Kenyan compliance teams.",
    challenge:
      "Lexreg's team was processing regulatory filings through a patchwork of manual spreadsheets and email chains — slow, error-prone, and impossible to audit under Kenya's strict compliance timelines.",
    approach:
      "We engineered a real-time filing pipeline with deterministic validation rules, structured audit trails, and automated status tracking, replacing the manual process end to end.",
    outcome:
      "Lexreg now processes filings in real time with a system built for the reliability regulatory work demands.",
    quote:
