      ...
      <ServicePageShell>
        ...
        <section className="max-w-[1240px] mx-auto py-16 border-t border-black/[0.06]">
          <div className="flex items-center gap-2 mb-8">
            <span className="w-6 h-6 rounded-full bg-cyan-500 flex items-center justify-center text-white text-xs font-bold">
              Z
            </span>
          ...
          <div className="flex flex-col gap-4">
            {workflows.map((w) => (
              <div key={w.title} className="rounded-2xl border border-black/[0.06] bg-neutral-50 p-6">
                ...
                <p className="text-xs sm:text-sm text-neutral-500 leading-relaxed">{w.steps}</p>
              </div>
            ))}
          </div>
        </section>
